...
#define		FAN_LEVEL1_PULSE_COUNT  100         //  500/60*12 = 100;  //·ç»ú·µ»ØµÄÂö³åÊı
#define		FAN_LEVEL2_PULSE_COUNT  300       //  1500/60*12 = 300;
#define		FAN_LEVEL3_PULSE_COUNT	520			//  260/60*12 = 520;
//#define 	FAN_LEVEL12_PULSE_COUNT  170           //·Û³¾ÔÚ70-100 1000/60*12 = 200
...
#define		FAN_LEVEL1_PULSE	92   //1µµµÄÂö³åÊı89
...
void power_off(void);
void power_on(void);
void chang_init_up_power(void);  //¸Ä±äÉÏµç³õÊ¼×´Ì¬
